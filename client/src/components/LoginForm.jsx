...
import { Input, Form, SubmitInput, FormError } from "../styles/styledForm";
...
export const LoginForm = () => {
    ...
    return (
        <>
            <Form onSubmit={handleSubmit((loginCredentials) => handleLogin(loginCredentials))}>
            ...
            {isError && <div>{error.message} {error.response.data}</div>}
